...
LABELS = {
    ...
    "transfer_in_rate": "Transfer-In Rate / อัตราการย้ายเข้า",
    "transfer_movement_rate": "Student Transfer Movement Rate / อัตราการย้ายคณะรวม",
    "transfer_out_rate": "Transfer-Out Rate / อัตราการย้ายออก",
